...
$GLOBALS['TCA']['tx_kesearch_indexerconfig']['columns']['startingpoints_recursive']['displayCond'] .= ',tx_eahcoursedirectory_domain_model_certificate';
...
$GLOBALS['TCA']['tx_kesearch_indexerconfig']['columns']['sysfolder']['displayCond'] .= ',' . \ErnstAbbeHochschuleJena\EahcoursedirectoryIndexer\Indexer\CertificateIndexer::KEY;
